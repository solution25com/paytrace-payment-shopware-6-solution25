...
namespace solu1Paytrace;

use solu1Paytrace\PaymentMethods\PaymentMethodInterface;
use solu1Paytrace\PaymentMethods\PaymentMethods;
...
class solu1Paytrace extends Plugin
{
        ...
        foreach (PaymentMethods::PAYMENT_METHODS as $paymentMethod) {
            ...
            if (!$uninstallContext->keepUserData()) {
                ...
                $connection->executeStatement(
                    ...
                    [
                        'migrationPattern' => 'solu1Paytrace\Migration\%',
                    ]
                );
            }
        }
