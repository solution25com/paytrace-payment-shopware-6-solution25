...
class PayTraceSavedCardsController extends StorefrontController
{
    ...
    public function __construct(
        EntityRepository $customerVaultRepository,
    ...
    #[Route(
        path: '/account/payTrace-saved-cards',
        name: 'frontend.account.payTrace-saved-cards.page',
        methods: ['GET']
    )]
    public function savedCard(SalesChannelContext $context): Response
    {
        ...
        $customerVaultRecords = $this->customerVaultRepository->search(
            $criteria,
            $context->getContext()
        )->getEntities();
    ...
    #[Route(
        path: '/account/payTrace-saved-cards/add-card',
        name: 'frontend.account.payTrace-saved-cards-add-card.page',
        methods: ['POST']
    )]
    ...
    #[Route(
        path: '/account/payTrace-saved-cards/delete-card/{vaultedCustomerId}',
        name: 'frontend.account.payTrace-saved-cards-delete-card.page',
        methods: ['POST']
    )]
